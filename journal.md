...
The RT datasets used in attempt #2 has the following pattern:
...
The right angle triangles generated in the attempt #2 are ordered (a < b < c)
...
### Drawback of RT dataset
The RT datasets used in attempt #3 has the following pattern
1. Difference between large two sides is 1
2. RT triangle numbers are much larger
...
The RT datasets used in Attempt #4 has the following pattern:
...
are higher than the above mentioned results of Attempt #5.
...
Triangle and Right triangle is generated the same way as in Attempt #5.
